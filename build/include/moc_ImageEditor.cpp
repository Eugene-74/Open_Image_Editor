...
static constexpr auto qt_meta_stringdata_ZN11ImageEditorE = QtMocHelpers::stringData(
    "ImageEditor",
    "switchToImageBooth",
    "",
    "switchToMainWindow"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ImageEditorE[] = {
...
Q_CONSTINIT const QMetaObject ImageEditor::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ImageEditorE.offsetsAndSizes,
    qt_meta_data_ZN11ImageEditorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ImageEditorE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ImageEditor, std::true_type>,
        // method 'switchToImageBooth'
...
void ImageEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ImageEditor::*)();
            if (_q_method_type _q_method = &ImageEditor::switchToImageBooth; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ImageEditor::*)();
            if (_q_method_type _q_method = &ImageEditor::switchToMainWindow; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ImageEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ImageEditorE.stringdata0))
