...
static constexpr auto qt_meta_stringdata_ZN10ImageBoothE = QtMocHelpers::stringData(
    "ImageBooth",
    "switchToImageEditor",
    "",
    "switchToMainWindow"
...
Q_CONSTINIT static const uint qt_meta_data_ZN10ImageBoothE[] = {
...
Q_CONSTINIT const QMetaObject ImageBooth::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10ImageBoothE.offsetsAndSizes,
    qt_meta_data_ZN10ImageBoothE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10ImageBoothE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ImageBooth, std::true_type>,
        // method 'switchToImageEditor'
...
void ImageBooth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ImageBooth::*)();
            if (_q_method_type _q_method = &ImageBooth::switchToImageEditor; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ImageBooth::*)();
            if (_q_method_type _q_method = &ImageBooth::switchToMainWindow; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ImageBooth::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10ImageBoothE.stringdata0))
