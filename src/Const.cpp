...
const QString Const::IconPath::EDIT_EXIF = ":/icons/editExif.png";
...
const QString Const::Tooltip::ImageBooth::EDIT_EXIF = "Edit exif data of selected images";
...
const QString Const::Tooltip::ImageEditor::EDIT_EXIF = "Edit exif data of the image";
