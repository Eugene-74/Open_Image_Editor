...
/**
 * @brief Constructor for ImageLabel
 ...
 */
ImageLabel::ImageLabel(std::shared_ptr<Data> data, const QString& imagePath, QString toolTip, QWidget* parent, QSize* sizePtr, bool setSize, int thumbnail, bool square, bool force)
 ...
 */
void ImageLabel::updateStyleSheet() {
 ...
 */
void ImageLabel::setDisabledColor(std::string borderColor, std::string backgroundColor) {
 ...
 */
void ImageLabel::setDisabledBorderColor(std::string borderColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setDisabledBackgroundColor(std::string backgroundColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setBorderColor(std::string borderColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setHoverBorderColor(std::string hoverBorderColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setInitialBorderColor(std::string borderColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setInitialHoverBorderColor(std::string hoverBorderColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setBackgroundColor(std::string backgroundColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setHoverBackgroundColor(std::string hoverBackgroundColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setInitialBackgroundColor(std::string backgroundColor) {
 ...
 * @details This function doesn't updates the style sheet of the label
 */
void ImageLabel::setInitialHoverBackgroundColor(std::string hoverBackgroundColor) {
 ...
 * @details This function also updates the style sheet of the label
 */
void ImageLabel::setInitialBorder(std::string borderColor, std::string hoverBorderColor) {
 ...
 * @details This function also updates the style sheet of the label
 */
void ImageLabel::setBorder(std::string borderColor, std::string hoverBorderColor) {
    setBorderColor(borderColor);
    setHoverBorderColor(hoverBorderColor);
    updateStyleSheet();
}
 ...
 * @details This function also updates the style sheet of the label
 */
void ImageLabel::setInitialBackground(std::string backgroundColor, std::string hoverBackgroundColor) {
 ...
 * @details This function also updates the style sheet of the label
 */
void ImageLabel::setBackground(std::string backgroundColor, std::string hoverBackgroundColor) {
    setBackgroundColor(backgroundColor);
    setHoverBackgroundColor(hoverBackgroundColor);
    updateStyleSheet();
}
 ...
 */
void ImageLabel::resetBackground() {
 ...
 * @details This function also updates the style sheet of the label
 */
void ImageLabel::setBorderRadius(int border_radius) {
 ...
 * @details This function also updates the style sheet of the label
 */
void ImageLabel::setBorder(int border) {
    this->border = border;
    updateStyleSheet();
}
 ...
 */
void ImageLabel::addLogo(QColor logoColor, QColor logoTextColor) {
 ...
 * @details This function also sets the logo visible and updates the label
 */
void ImageLabel::addLogo(QColor logoColor, QColor logoTextColor, int logoNumber) {
    setLogoColor(logoColor);
    setLogoTextColor(logoTextColor);
 ...
 */
void ImageLabel::setLogoNumber(int logoNumber) {
    if (logoNumber < 0) {
        logoText = "?";
 ...
 */
void ImageLabel::setLogoColor(QColor logoColor) {
 ...
 * @details This function also updates the label
 */
void ImageLabel::setLogoTextColor(QColor logoTextColor) {
 ...
 * @details This function also updates the label
 */
void ImageLabel::setLogoVisible(bool logoVisible) {
 ...
 * @details This function also updates the label
 */
void ImageLabel::setLogoEnabled() {
    setLogoVisible(true);
    update();
}
/**
 ...
 * @details This function also updates the label
 */
void ImageLabel::setLogoDisabled() {
    setLogoVisible(false);
    update();
}

/**
 * @brief Set the opacity of the label
 * @param opacity Opacity value between 0.0 and 1.0
 */
void ImageLabel::setOpacity(double opacity) {
    if (opacity < 1.0) {
